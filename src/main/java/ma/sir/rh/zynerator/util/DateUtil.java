...
public class DateUtil {
    ...
    public static final String DATE_FORMAT_WITH_HOUR = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    public static final String DATE_FORMAT_NAME = "ddMMyyyyHHmmss";
    public final static String DATE_FORMAT_FILE = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    public static final String HOUR_FORMAT = "HH:mm:ss";
    public static final String DATE_FORMAT_ENG = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    public static final String DATE_FORMAT_PF = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
